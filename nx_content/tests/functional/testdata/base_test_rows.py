movie_test_base_row = {
    ...
    "directors": [{"id": "dc12b8fc-3c82-4d31-ad8e-72b69f4e3f95", "name": "Stan"}],
    "actors": [
        {"id": "a5232057-cf81-47ca-9e46-5ccf27300678", "name": "Elizabeth"},
...
persons_test_base_row = {
    ...
    "name": "Elizabeth",
    "films": [
        {"id": "d7bfb1fb-3157-4beb-a58a-7a58daa01845", "roles": ["actor", "writer"]}
    ],
}
