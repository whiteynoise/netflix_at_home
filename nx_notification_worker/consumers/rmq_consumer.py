...
from abstracts import AbstractBrokerConsumer
from configs.logger_config import logger
from configs.worker_settings import RabbitMQConfig


class RabbitMQConsumer(AbstractBrokerConsumer):
    def __init__(self, broker_config: dict):
        self.broker_config: RabbitMQConfig = broker_config
            ...
            async for message in iterator:
                try:
                    async with message.process():
                        await callback(notification_info=orjson.loads(message.body))
